...
pub fn write_colour(pixel: &mut Rgb<u8>, pixel_colour: Colour) {
    ...
    let ir = (256.0 * inensity.clamp(r)) as u8;
    let ig = (256.0 * inensity.clamp(g)) as u8;
    let ib = (256.0 * inensity.clamp(b)) as u8;
